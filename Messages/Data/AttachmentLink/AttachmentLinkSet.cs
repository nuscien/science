...
public class AttachmentLinkSet : IJsonObjectHost
{
    ...
    public bool Contains(AttachmentLinkItem item)
        => ResourceEntityUtils.Contains(Items, item);
    ...
    public bool Contains(Uri link)
        => ResourceEntityUtils.Contains(Items, link);
    ...
    public void operator +=(AttachmentLinkItem value)
        => Add(value);
