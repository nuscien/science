...
/// <summary>
/// The relationship information entity.
/// </summary>
    ...
    where TOwner : BaseResourceEntityInfo
{
    ...
    /// <summary>
    /// Gets the supertype of owner resource.
    /// </summary>
    [JsonIgnore]
#if NETCOREAPP
    [NotMapped]
#endif
    public string OwnerSupertype => Owner?.GetProperty<string>(nameof(Supertype));

    /// <summary>
    /// Gets the type of owner resource.
    /// </summary>
    [JsonIgnore]
#if NETCOREAPP
    [NotMapped]
#endif
    public string OwnerType => Owner?.GetProperty<string>(nameof(ResourceType));

    /// <summary>
    /// Gets the state of owner resource.
    /// </summary>
    [JsonIgnore]
#if NETCOREAPP
    [NotMapped]
#endif
    public ResourceEntityStates OwnerState => Owner?.State ?? ResourceEntityStates.Deleted;
    ...
    /// <summary>
    /// Gets the type of owner resource entity instance.
    /// </summary>
    /// <returns>The exact runtime type of the owner resource entity instance.</returns>
    public Type GetOwnerType()
        => Owner?.GetType() ?? typeof(TOwner);
    ...
    where TTarget : BaseResourceEntityInfo
{
    ...
    /// <summary>
    /// Gets the supertype of target resource.
    /// </summary>
    [JsonIgnore]
#if NETCOREAPP
    [NotMapped]
#endif
    public string TargetSupertype => Target?.GetProperty<string>(nameof(Supertype));

    /// <summary>
    /// Gets the type of target resource.
    /// </summary>
    [JsonIgnore]
#if NETCOREAPP
    [NotMapped]
#endif
    public string TargetType => Target?.GetProperty<string>(nameof(ResourceType));

    /// <summary>
    /// Gets the state of target resource.
    /// </summary>
    [JsonIgnore]
#if NETCOREAPP
    [NotMapped]
#endif
    public ResourceEntityStates TargetState => Target?.State ?? ResourceEntityStates.Deleted;
    ...
    /// <summary>
    /// Gets the type of target resource entity instance.
    /// </summary>
    /// <returns>The exact runtime type of the target resource entity instance.</returns>
    public Type GetTargetType()
        => Target?.GetType() ?? typeof(TTarget);
}
